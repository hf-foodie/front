...
import { getRestaurantPosts } from '@/data/posts'
...
const filterTabs = [
  ...
  { name: '카테고리', value: 'categories', icon: Folder02Icon },
  { name: '태그', value: 'tags', icon: Tag02Icon },
  { name: '작가별', value: 'authors', icon: UserListIcon },
]
...
const PageSearch = async ({
  ...
  if (searchTab === 'posts') {
    const restaurantPosts = await getRestaurantPosts();
