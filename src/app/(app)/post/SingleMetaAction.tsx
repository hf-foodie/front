...
interface Props extends Pick<TPostDetail, 'likeCount' | 'liked' | 'commentCount' | 'handle'> {
  className?: string
}

const SingleMetaAction: FC<Props> = ({ className, likeCount, liked, commentCount, handle }) => {
  return (
