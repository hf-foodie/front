...
import MagazineBadgeList from '@/components/Magazine/MagazineBadgeList'
import MagazineCardMeta from '@/components/Magazine/MagazineCardMeta'
...
const CardMagazineMain: FC<Props> = ({ className, size = 'normal', magazine }) => {
  const {
    names,
    title,
    featuredImage,
...
export default CardMagazineMain
